        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              onPressed: () async {
                final imagePath =
                    await CameraGalleryServiceImpl().selectImage();
            ...
            IconButton(
              onPressed: () async {
                final imagePath = await CameraGalleryServiceImpl().takeImage();
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            ...
            ref
                .read(productFormProvider(productState.product!).notifier)
                .onFormSubmit()
                .then((value) => !value ? null : showSnackbar(context));
          },
...
class _SizeSelector extends StatelessWidget {
  ...
  final void Function(List<String> selectedSizes) onChanged;

  const _SizeSelector({required this.selectedSizes, required this.onChanged});
  ...
  Widget build(BuildContext context) {
    return SegmentedButton(
      ...
      onSelectionChanged: (newSelection) {
        ...
        onChanged(List.from(newSelection));
      },
...
class _GenderSelector extends StatelessWidget {
  ...
  final void Function(String selectedGender) onChanged;
